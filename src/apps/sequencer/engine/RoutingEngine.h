...
private:
    ...
    void writeParam(Routing::Param param, int track, int pattern, float value);
    void writeTrackParam(Routing::Param param, int track, int pattern, float value);
    ...
    float readParam(Routing::Param param, int track, int pattern) const;
