...
void SongPage::draw(Canvas &canvas) {
    ...
    // draw table header
    {
        ...
        for (int colIndex = 0; colIndex < 10; ++colIndex) {
            canvas.setColor(isHighlighted(colIndex) ? Canvas::Color::Bright : Canvas::Color::Medium);
    ...
    for (int rowIndex = 0; rowIndex < RowCount; ++rowIndex) {
        ...
        // draw table cells
        for (int colIndex = 0; colIndex < 10; ++colIndex) {
            canvas.setColor(slotIndex == _selectedSlot && isHighlighted(colIndex) ? Canvas::Color::Bright : Canvas::Color::Medium);
